    ...
    <Gutter>
      <div className="z-10 mt-24 flex min-h-svh items-center justify-center py-6 text-gray-200">
        <form
          ...
          className={
            'flex w-full flex-col items-center justify-center gap-2 rounded-xl bg-neutral-950 px-4 py-6 shadow shadow-neutral-500 sm:max-w-96 md:max-w-[40rem] md:gap-4 md:px-6 md:py-6'
          }
        >
          ...
          <div className="w-full">
            ...
            <input
              ...
              className="h-10 w-full rounded border border-neutral-400 bg-neutral-900 px-2 py-1 text-sm text-neutral-200 placeholder:text-neutral-300 md:text-base"
          ...
          <div className="w-full">
            ...
            <textarea
              ...
              cols={1}
              rows={5}
              className="h-10 min-h-64 w-full gap-4 rounded border border-neutral-400 bg-neutral-900 px-2 py-1 text-sm text-neutral-200 placeholder:text-neutral-300 md:text-base"
              onChange={formik.handleChange}
          ...
          <div className="w-full">
            ...
            <select
              id="gender"
              className="mr-2 h-10 w-full rounded border border-neutral-400 bg-neutral-900 px-2 py-1 text-sm text-neutral-200 placeholder:text-neutral-300 md:text-base"
              onChange={formik.handleChange}
