  ...
  return (
    <section className="h-full w-full flex-1 rounded-xl bg-neutral-900 bg-opacity-90 p-4 lg:h-auto xl:p-6">
      <form className="flex flex-col gap-1">
        <section className="mb-1 flex w-full flex-col gap-4 border-b border-neutral-500 pb-4 lg:flex-row">
          <div className="cursor-pointer space-y-1">
            <p className="text-neutral-200">Sizning Rasmingiz:</p>
            <div className="flex size-32 flex-col items-center justify-center gap-1 rounded-xl border border-dashed border-neutral-300 bg-gradient-to-r from-neutral-800 to-stone-900 p-6 transition-all hover:from-neutral-900 hover:to-stone-900">
              <Image
        ...
        <section className="mb-4 grid grid-cols-1 gap-2 lg:grid-cols-2">
          ...
          <div className="col-span-2 w-full lg:col-span-1">
            ...
            <input
              ...
              type="text"
              className="h-10 w-full rounded border border-neutral-400 bg-gradient-to-r 
              from-neutral-800 to-stone-900 p-2 text-sm text-neutral-200 
              placeholder:text-neutral-300 md:h-12 md:text-base"
            />
          </div>
          <div className="col-span-2 w-full">
            ...
            <textarea
              ...
              cols={1}
              rows={5}
              className="h-10 min-h-64 w-full gap-4 rounded border border-neutral-400 
              bg-gradient-to-r from-neutral-800 to-stone-900 p-2 text-sm text-neutral-200
               placeholder:text-neutral-300 md:h-12 md:text-base"
            />
          </div>
        </section>
        <button
          className="mt-auto w-full rounded border border-black bg-primary bg-opacity-75 py-2 font-semibold text-neutral-900 transition-all hover:bg-opacity-100 sm:max-w-64"
          type="submit"
          onClick={() => update()}
        >
          {t('Saqlash')}
