...
const SettingsNavigation = ({ setTab, currentTab }) => {
  ...
  return (
    <section className="flex w-full flex-row justify-between rounded-xl bg-neutral-900/80 bg-opacity-90 px-4 py-2 fade-in lg:w-64 lg:flex-col lg:py-4 xl:gap-1">
