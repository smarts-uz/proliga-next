...
const League = ({ item}) => {
  ...
  return (
    <>
      <article
        className="relative flex min-h-28 cursor-pointer items-center gap-4 rounded-sm border border-neutral-500 bg-neutral-700 p-4"
      ...
      >
        ...
        <div>
          ...
          <p className="text-neutral-400">Description of League</p>
        </div>
      </article>
