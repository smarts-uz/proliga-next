...
const GameBrief = () => {
  ...
  return (
    <section className="mx-auto fade-in-fast flex h-min w-full max-w-[30rem] flex-col justify-between gap-6 rounded-2xl border border-primary border-opacity-50 bg-neutral-950 px-10 py-6 transition-all hover:border-opacity-100 md:max-w-[40rem] lg:mx-0 lg:w-1/2">
      ...
      <div className="flex flex-col gap-6 border-b border-neutral-700 pb-2">
        ...
        <div className="flex justify-between text-lg">
          <p className="text-neutral-100">{t("Turnirdagi o'rtacha ochkolar")}</p>
          <p className="text-sm uppercase text-primary md:text-base">
