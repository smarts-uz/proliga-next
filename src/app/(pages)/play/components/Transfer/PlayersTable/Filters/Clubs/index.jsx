...
const ClubsFilter = ({ column, columnFilterValue }) => {
  ...
  return (
    <select
      className="h-8 w-full max-w-36 truncate border bg-neutral-950 px-1 text-neutral-200 shadow selection:accent-primary checked:bg-red-400 active:accent-primary md:max-w-48"
