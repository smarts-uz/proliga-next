...
const Matches = () => {
  ...
  return (
    <div className="relative mx-auto flex min-h-[36rem] w-full max-w-[32rem] flex-col gap-2 rounded-xl bg-neutral-900 p-4 shadow shadow-neutral-600 md:p-6 lg:mx-0 lg:w-auto xl:flex-grow">
