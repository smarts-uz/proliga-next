...
const ArticleModal = ({ item, toggleModal, isModalOpen, date }) => {
  return (
    <Dialog onOpenChange={toggleModal} open={isModalOpen}>
      <DialogContent className="overflox-y-auto flex max-h-[96vh] min-h-[45vh] w-[96%] max-w-[64rem] flex-col gap-3 overflow-y-auto overflow-x-hidden rounded-2xl border border-neutral-500 bg-neutral-900 px-2 py-4 text-neutral-200 xs:w-[96%] xs:px-4 sm:w-4/5 md:p-6 lg:max-h-[90vh] lg:w-3/4 xl:w-3/5">
