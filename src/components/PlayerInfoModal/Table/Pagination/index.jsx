...
const PlayerInfoTablePagination = ({ table }) => {
  const currentIndex = table.getState().pagination.pageIndex

  return (
    <section className="mt-2 flex items-center justify-center gap-2 overflow-x-auto py-0.5">
      <PaginationButton
...
export default PlayerInfoTablePagination
