...
const ClubsFilter = ({ column }) => {
  ...
  return (
    <select
      className="h-8 max-h-64 w-full truncate rounded border border-neutral-500 bg-neutral-950 px-1 text-neutral-200 shadow sm:col-span-1 sm:max-w-36 md:max-w-48"
