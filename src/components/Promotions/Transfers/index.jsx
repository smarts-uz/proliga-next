...
const Transfers = () => {
    return (
        <div className={'w-full bg-[#222222] py-16'}>
         <Gutter className={'bg-center   bg-cover bg-custom-image flex flex-col space-y-16 justify-center align-center'}>
            <h2 className={'text-4xl font-bold uppercase mx-auto'}>TRANSFERLARNI AMALGA OSHIRING</h2>
